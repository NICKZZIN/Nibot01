...
╔════════════════
║_ℹ️ - Grupo oficial do programador deste bot!_ *.barzin*
║_ℹ️ - Se quiser saber do Nibot ou como construir "ele", use_ *.about* .
╠════════════════
║*1 - .Nibot (mensagem)*
...
╠════════════════
║*8 - .ping*
║_Bem, isso é pra medir o quão rapida eu estou._
╠════════════════
║*9 - .tts (sigla de idioma) [frase]*
...
╠════════════════
║*38 - .dva*
║_Isso e pra obter fotos da DVA do LoL, embora eu não goste desse jogo..._
╠════════════════
║*39 - .hug*
...
╠════════════════
║*101 - .stalkig <username>*
║_Stalkeie instagram._
╠════════════════
║*102 - .stalktw <username>*
║_stalkeie twitter._
╠════════════════
║*103 - .maps <local>*
...
╠════════════════
║*3 - .Mp3 <link do YouTube>*
║_Baixe audios por link._
╠════════════════
║*4 - .Mp4 <link do YouTube>*
...
╭━─━─━─≪✠≫─━─━─━╮
   ...
   Só O Mais Brabo Pode Usar rsrs
╰━─━─━─≪✠≫─━─━─━╯
╔════════════════
║*1 - .Clearall*
...
╔════════════════
║*1 - .kick @user*
║_Expulsar X9 (pode ser mais de 1)._
╠════════════════
║*2 - .promote @user*
...
╠════════════════
║*6 - .del [Marque a mensagem do ║BOT]*
...
╔════════════════
║Caso não entenda, chame o meu dono, ║use o comando .criador ou pergunte no ║grupo que alguém com certeza te ║ajudará! XD
╠════════════════
║Quando eu tiver tempo colocarei ║tutoriais aqui e.e
╠════════════════
║Obrigado pelo uso!
╠════════════════
║Programador oficial desse BOT: ║wa.me/5512997277680
╚════════════════`
}
...
function donate() {
    return `
 Agradeço muito pelo suporte, de antemão, doações não são necessarias para mim, o programador do Nibot, basta que você cuide bem do Nibot e auxilie os usuarios, se você deseja ver ele ficar melhor mais rapidamente, você pode contribuir com qualquer quantia de dinheiro, que é usado para criar comandos que são pagos.
Caso você queira contibuir, o picpay do criador desse bot é @userlucas123, qualquer coisa entre em contato comigo pela github > github.com/NICKZZIN/Nibot01. ;D ❤️`
}
...
exports.convh = convh()
function convh() {
	return `_Para usar você deve digitar_ *.conv [-sigla] [Número para conversão]* _, confira abaixo as siglas e um exemplo._
